        ...
        <div className="service-item">
          ...
          <div className="service-content">
            ...
            <p className="service-description">
              ...
              offer our guests a well-balanced meal. From 07:30 to 10:00 we
              serve a buffet in our breakfast room. If you want a "breakfast to
              go" instead of breakfast, our staff can also prepare you for it.
            </p>
          </div>
        </div>
        <div className="service-item">
