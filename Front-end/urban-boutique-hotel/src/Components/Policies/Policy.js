      ...
      {loading ? (
        ...
        <div className="policies-container">
          ...
          <p>
            ...
            share information on or in connection with our hotel services. If
            you have any questions or concerns, please don't hesitate to contact
            us using the information provided in the "Contact Us" section below.
            When we refer to "Urban Boutique Hotel" (or any similar terms like
            "we" or "us") in this privacy policy, we mean the entity that
            controls and is responsible for your information. This includes all
            subsidiaries that help provide and support our hotel services. Thank
            you for choosing Urban Boutique Hotel as your destination in Vienna.
            We look forward to providing you with a memorable and comfortable
            stay.
          </p>
          {policies.map((policy) => (
            <div key={policy.id}>
